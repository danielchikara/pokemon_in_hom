"""
Django settings for pokemon_in_hom project.
...
SECRET_KEY = 'django-insecure-$a4d&b&3o#%+lv$l3qpg#k^es$mc39a!_&o#7b3@=327f!a9r7'
...
ROOT_URLCONF = 'pokemon_in_hom.urls'
...
WSGI_APPLICATION = 'pokemon_in_hom.wsgi.application'
